    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                System.out.println("Sender data before passing");
                System.out.println(i.getStringExtra("key_senderFullName"));
                System.out.println(i.getStringExtra("key_senderContactInfo"));
                System.out.println(i.getStringExtra("key_senderCountry"));
                System.out.println(i.getStringExtra("key_senderAddress"));
                // pass data also
                startActivity(i);
                finish();
            }
